...
// test('Should throw firstname/lastname validation error', async () => {
//     const resp = await request(app).post("/api/register").send({
//         firstName: 'a', // length is less then 3
...
//         firstName: 'Name should consist of letters between 3 to 15 characters long.' 
//     })
// })
